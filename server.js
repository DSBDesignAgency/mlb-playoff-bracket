...
const bracketData = {
    AL: {
        ...
        division: [
            { team: '2-3', logo: 'images/AL/Tigers-e.png', seed: 6 },
        ],
        divisionA: [
            { team: '3-2', logo: 'images/AL/Guardians.png', seed: 2 },
        ],
        division2: [
    ...
    NL: {
        ...
        champions3: [
            { team: '2-4', logo: 'images/NL/Mets-e.png', seed: 6 },
        ],
        champions4: [
            { team: '4-2', logo: 'images/NL/Dodgers.png', seed: 1 },
        ],
    },
    worldSeries: {
        contenders: [
